...
public class TechnicalLoginPageController {
    @FXML
...
//                System.out.println(rs.getString(1));
                ...
                staticClass.myParent="technicalMW.fxml";
                staticClass.aff_num=loginID.getText().trim();
                Stage st = (Stage) loginBtn.getScene().getWindow();
                BorderPane root = (BorderPane) FXMLLoader.load(getClass().getResource("technicalMW.fxml"));
